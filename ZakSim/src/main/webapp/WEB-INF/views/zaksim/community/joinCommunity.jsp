            ...
            <div class="col-sm-11" style="margin-top: 50px; margin-right: 50px;">
                ...
                <div style="margin-left: 50px; margin-right: 50px;">
                    <div id="groupBorder" style="margin-bottom: 100px;">
                        <div style="padding-left: 40px; padding-right: 100px; padding-top: 40px;">
                            <div class="form-inline">
                                <img src="https://picsum.photos/1200/350/?image=15" alt="..." class="rounded-circle" style="margin-right: 100px">
                                <div>
                                    <h4 style="margin-bottom: 50px; margin-right: 30px;"><strong>참여하고 있는 모임1 </strong></h4>
                                    <div>
                                        <p>
                                ...
                                <div>
                                    <button type="button" class="btn btn-danger" style="margin-top; 20px;"><a href="joinCommunity.html">상세보기</a></button><br>
                                    <button type="button" class="btn btn-info" style="margin-top:  20px;">포기하기</button>
                                </div>
                                <div>
                ...
                <div id="groupBorder" style="margin-bottom: 100px;">
                    <div style="padding-left: 100px; padding-right: 100px; padding-top: 40px;">
                        <div class="form-inline">
                            <img src="https://picsum.photos/1200/350/?image=21" alt="..." class="img-thumbnail" style="margin-right: 100px">
                            <div>
                                <h4 style="margin-bottom: 50px; margin-right: 110px;"><strong>참여하고 있는 모임2</strong></h4>
                                <p>
                                    <span>참여자 : </span>
                                    <span>20</span>
                                </p>
                            ...
                            <div>
                                <button type="button" class="btn btn-outline-danger" style="margin-top; 40px;">상세보기</button><br>
                                <button type="button" class="btn btn-outline-info" style="margin-top:  20px;">포기하기</button>
                            </div>
                ...
                <div id="groupBorder" style="margin-bottom: 100px;">
                    <div style="padding-left: 100px; padding-right: 100px; padding-top: 40px;">
                        <div class="form-inline">
                            <img src="https://picsum.photos/1200/350/?image=20" alt="..." class="img-thumbnail" style="margin-right: 100px">
                            <div>
...
<link rel="stylesheet" type="text/css" href="/css/community/joinCommunity.css">
