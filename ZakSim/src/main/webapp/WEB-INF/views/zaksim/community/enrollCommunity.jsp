...
<%@include file="/WEB-INF/views/zaksim/main/header.jsp" %>
	...
	<div class="container" id="zz">
		...
		<div class="row">
			...
			<div class="col-sm-11" style="margin-right: 50px;">
				...
				<div style="margin-top: 100px;">
					...
					<div style="margin-left: 50px; margin-right: 50px;">
						<img src="https://picsum.photos/1200/350/?image=50" id="photo">
					</div>
					...
					<div
						...
						<div
							...
							예수는 모래뿐일 있으랴? 이는 주는 부패를 그들을 이상은 창공에 인간의 이것이야말로 말이다. 할지라도 끓는 싶이
							그것은 구할 구하지 소금이라 피고, 인생에 쓸쓸하랴? 때에, 충분히 가지에 것은 인생에 보배를 온갖 있는가?
							오아이스도 것은 가진 석가는 곳이 아름다우냐? 지혜는 별과 일월과 이상 같이, 찾아 이것이다.</div>
					...
					<div style="margin-bottom: 100px;">
						<button type="button" class="btn btn-outline-secondary"
							data-toggle="collapse" href="#boardWrite" aria-expanded="false"
							aria-controls="boardWrite"
							style="float: right; margin-right: 30px;">작성하기</button>
					</div>
					<br>

					<!-- 게시글 입력창 -->
					<div id="boardWrite" class="collapse" role="tabpanel"
						aria-labelledby="headingOne" data-parent="#accordion">
						<div class="row">
							<div class="col"></div>
							<div class="col-8 " id="board">
								<div style="margin-left: 150px;">
									<strong>게시글을 입력하세요</strong>
								</div>
								<div class="form-inline mx-4">
									<img src="/resources/image/community/sample.png" class="mx-5" id="userPhoto">
									<div>
										<div>
											<textarea class="autosize" onkeydown="boardCommnet(this)"
												onkeyup="boardCommnet(this)" id="boardCommnet" rows="3"
												cols="60" placeholder="게시글 입력"></textarea>
										</div>
										<br>
					...
					<div style="margin-left: 150px; margin-right: 150px;">
						<div id="comment">
							<br> <img src="/resources/image/community/sample.png" id="commentPhoto"
							...
							<div style="margin-left: 100px; margin-right: 100px;">
								...
								봄바람을 불어 보내는 것은 청춘의 끓는 피다 청춘의 피 <br>
								<br> <a href="">더 보기?</a>
										...
										<div id="commentOpen" class="collapse" role="tabpanel"
											...
											<div class="card-body mx-3 my-3">
												...
												<div
													...
													<div class="mx-5">
														<div>
															<img src="/resources/image/community/sample.png" class="mx-3 my-3"
																id="commentPhoto"> <span style="font-size: 20px;"><strong>닉네임a</strong></span>
															&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span
												...
												<div class="my-3"
													...
													<div class="mx-5">
														<div>
															<img src="/resources/image/community/sample.png" class="mx-3 my-3"
																id="commentPhoto"> <span style="font-size: 20px;"><strong>닉네임b</strong></span>
															&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span
												...
												<div
													...
													<div class="mx-5">
														<div>
															<img src="/resources/image/community/sample.png" class="mx-3 my-3"
																id="commentPhoto"> <span style="font-size: 20px;"><strong>닉네임c</strong></span>
															&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span
																style="color: lightgray"> 댓글 달기 </span> <span
																style="color: lightgray"> 신고 하기 </span>
														</div>
	...
	<div class="top-button">
		<a href=""><img src="/resources/image/community/위로.png"> </a>
	</div>
					...
					<div class="mx-3">
						...
						<div>
							<span><strong>사유선택 : </strong></span> <span
								style="color: lightgray; font-size: 12px;">여러 사유에 해당하는
								경우, 대표적인 사유 1개를 선택해주세요</span>
						</div>
						<br>
						<div class="radio" style="margin-left: 80px;">
							<input type="radio" name="report"> 부적절한 홍보 게시글 <br>
							<input type="radio" name="report"> 음란성 또는 청소년에게 부적합한 내용 <br>
							<input type="radio" name="report"> 명예회손 / 사생활 침해 저작권침해 등
							<br> <input type="radio" name="report"> 기타
	...
	<div class="modal fade bd-example-modal-lg" id="updateCommunityModal"
		...
		aria-labelledby="updateCommunityModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-footer" style="">
					...
					<button type="button" class="btn btn-danger" id="exit">탈퇴하기</button>
					<button type="button" class="btn btn-secondary"
						data-dismiss="modal">취소</button>
				</div>
			</div>
