  ...
  <div class="row text-dark pb-5 py-2 " style="background-color: rgba(94, 94, 94, 0.64);">
        ...
        <div class="col-md-3 rounded text-center" style="height: 650px; background-color: rgba(33, 33, 33, 0.67);">
          ...
          <div class="row my-4 text-white">
            ...
            <div class="col-md-12 d-inline-flex align-items-center my-1">
              <img class="img-fluid d-block  mx-4 mr-5" src="/resources/image/challenge/memoIcon.png" style="	height: 60px; width: 60px;">
              <h4> Memo </h4>
            </div>
            <div class="col-md-12 d-inline-flex align-items-center my-1">
          ...
          <div class="col-md-12 text-center my-4">
            <a type="file" class="btn text-white btn-lg w-100" style="background-color: gray;"> 서약서 다운로드 </a>
          </div>
          <div class="col-md-12 text-center">
            <button type="button" onclick="toEndChallenge();" class="btn text-white btn-lg w-100"  style="background-color: rgb(187, 68, 56);"> 작성 완료 </button>
          </div>
        </div>
        <div class="col-md-1"></div>
